...
.thumb { width:290px; padding:1px; float:none; }
.thumb > img { width:100%; }
.thumb > .close { position:absolute; background-color:yellow; cursor:pointer; }
</style>
</head>
<body>
...
<div class="wrapperGray">
		<section class="layer">
				<div id="drop" style="position:relative; top:50px; left:900px; border:1px dashed white; width:300px; height:300px; padding:3px">
				<div id="thumbnails">
				</div>
				</div>	
				</br>
			...
			<form action="/hairLoading" method="post">
